...
export const Footer = () => {
    return (
        <div className='px-8 bg-blue-900'>
            <div className=' container m-auto py-12'>
                <footer className='grid md:grid-cols-3 gap-4 text-white'>
                    <div>
                        <a href="">
                            <svg width="150" height="40" viewBox="0 0 345.41368078175896 83">
                        ...
                        <p className='py-2'>Shortner is a Ads free URL shortner using which you can short the link of any length URL. Shortner has been providing URL shoetner service since 2020.</p>
                    </div>
                    <div className='md:px-4 md:text-center'>
                        <p className='font-semibold text-xl md:text-2xl'>Usefull Links</p>
                    ...
                    <div className='md:px-4 md:text-center'>
                        <p className='font-semibold text-xl md:text-2xl'>Lets Connect</p>
                        <ul className='py-2 flex space-x-4 md:justify-center'>
                            <li><a href=""><FaFacebook size={25} className="text-white" /></a></li>
                            <li><a href=""><FaTwitter size={25} className="text-white" /></a></li>
                            <li><a href=""><FaInstagram size={25} className="text-white" /></a></li>
                        </ul>
                    </div>
                </footer>
            </div>
            <div className='py-4 container m-auto flex justify-between text-md text-white flex-wrap'>
                <p className='flex'> Developed with <i><AiFillHeart className='m-1 text-red-600' size={20}/></i> by <a href='https://www.sujanban.com.np/' className='px-1'> Sujan Ban.</a></p>
